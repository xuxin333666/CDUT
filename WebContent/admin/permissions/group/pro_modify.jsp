		...
		<form class="form-horizontal">
			 <div class="form-group">
				    <div class="col-sm-6">
				      ...
				      <input type="text" class="form-control" name="id" id="group_id" value="${group.id }" readonly>
				    </div>
				    <div class="col-sm-6">
				    <label for="group_name" class="control-label">班级名称：</label>
				    <input type="text" class="form-control" name="name" id="group_name" value="${group.name}">
				    </div>
			  </div>
			  ...
			  <div class="form-group">
				    ...
				    <label for="group_groupManager" class="control-label">班主任：</label>
				      <input type="text" class="form-control" name="groupManager" id="group_groupManager" value="${group.groupManager }">
				    </div>
			  </div>	
			  ...
			  <div class="form-group">
				    <div class="col-sm-6">
					      ...
					      <input type="text" class="form-control" name="maleCount" id="group_maleCount" value="${group.maleCount }">
				    </div>
				    <div class="col-sm-6">
					   <label for="group_femaleCount" class="control-label">女生人数：</label>
					   <input type="text" class="form-control" name="femaleCount" id="group_femaleCount" value="${group.femaleCount }">
				    </div>
			   </div>
