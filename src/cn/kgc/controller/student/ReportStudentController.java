...
@WebServlet("/admin/permissions/student/report")
public class ReportStudentController extends HttpServlet {
	...
	private static final Logger logger = LoggerFactory.getLogger(ReportStudentController.class); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			logger.error("[ReportStudentController:doPost]" + e.getMessage());
		}
