...
@WebServlet("/admin/permissions/student/pro_fileUpload")
public class ProFileUploadStudentController extends HttpServlet {
	...
	private static final Logger logger = LoggerFactory.getLogger(ProFileUploadStudentController.class); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			logger.error("[ProFileUploadStudentController:doPost]" + e.getMessage());
